...
func ExampleIsStrictSubset() {
	fp.Pipe2(
		set.IsStrictSubset(set.New[int]()),
...
func ExampleIsStrictSuperset() {
	fp.Pipe2(
		set.IsStrictSuperset(set.New[int]()),
